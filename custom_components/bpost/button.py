"""Button platform for the bpost parcel tracker integration."""
...
async def async_setup_entry(
    ...
    """Set up the bpost refresh button from a config entry."""
    async_add_entities([BpostRefreshButton(entry)])


class BpostRefreshButton(ButtonEntity):
    """Button that forces an immediate poll of all tracked bpost parcels."""

    _attr_has_entity_name = True
    _attr_translation_key = "refresh"
    _attr_attribution = ATTRIBUTION

    def __init__(self, entry: BpostConfigEntry) -> None:
